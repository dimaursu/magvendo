  ...
  <div class="sales">
    ...
    <p><b><?php _e('Period'); ?>: <?php echo date("d-m-Y", strtotime($date_from)).' &mdash; '.date("d-m-Y", strtotime($date_to)); ?></b></p>
        <table class="ls-table">
             ...
             <?php 
                $products_sold = get_sales($date_from, $date_to, $user_id, $_SESSION['magazine_id']);
                $total = 0; 
                $date = '';
                $total_by_date = 0;
                $days = 0;
             ...
             <?php foreach ($products_sold as $key => $product_sold) : ?>
                 <?php if ($date != $product_sold['date']) : ?>
                     ...
                     <?php if($key > 0) : ?> 
                         <tr>
                           ...
                           <td><?php echo floor($total_by_date*0.1); $total_by_date = 0; ?></td>
                           <td></td> 
                         </tr>
                     <?php endif; ?>
                ...
                <tr class="total">
                  ...
                  <td><?php echo floor($total*0.1); ?></td>
                 </tr>
